...
/**
 * Testing utility for a class implementing the Q interface. A typical output
 * for the calls to BBQ.displayQ() below looks like:
 *
 *
 * Queue status Capacity 6, size 6, back at [6]: [ brisket ] [ rib eye ] [ ribs
 * ] [ pulled pork ] [ corn ] [ sausage ]
 *
 * Queue status Capacity 6, size 6, back at [6]: [ brisket ] [ rib eye ] [ ribs
 * ] [ pulled pork ] [ corn ] [ sausage ]
 *
 * Queue status Capacity 6, size 4, back at [4]: [ ribs ] [ pulled pork ] [ corn
 * ] [ sausage ] [ ] [ ]
 *
 *
 *
...
public class Grill {
  public static void main(String[] args) {
      ...
      System.out.println("After arrivals: ");
      grill.displayQ();
      System.out.println();
      ...
      System.out.println("No room for salmon: ");
      grill.displayQ();
      System.out.println();
      ...
      System.out.println("After departure of briskey and rib eye: ");
      grill.displayQ();
  }
}